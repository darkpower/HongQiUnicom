...
<div class="container">
    ...
    <!-- 内容 Start -->
    <div class="content" ms-controller="mobileBrands">
        ...
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <div id="tableData" class="col-xs-12 col-sm-9">
                <div class="col-sm-12 pull-left table-responsive">
                    <table id="vmTable" class="table table-striped">
                        <thead>
                        <tr>
                            <th style="width: 15%">品牌序号</th>
                            <th>品牌名称</th>
                            <th>相关操作</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ms-for="($index, $mobileBrand) in @mobileBrands">
                            <td>{{$mobileBrand.mobileBrandId}}</td>
                            <td>{{$mobileBrand.mobileBrandName}}</td>
                            <td>
                                <button option="manual" class="btn-block btn-default" data-toggle="modal" data-target="#myModal" ms-click="@openModal($broadband.broadbandId)">修改</button>
                                <button option="manual" class="btn-block btn-default" data-toggle="modal" data-target="#myModal" ms-click="@openModal($broadband.broadbandId)">删除</button>
                            </td>
                        </tr>
                        </tbody>
                        <tfoot>
            ...
            <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                ...
                <div class="optionSwitch list-group" style="margin-top: 0px; margin-bottom: 20px;">
                    <a class="list-group-item active" listType="手机品牌">手机品牌</a>
                    <a class="list-group-item" listType="手机型号">手机型号</a>
                </div>
...
<script>
    ...
    function getCountsWithAjax(vm) {
        $.ajax({
            url: "/ERP/Settings/Counts",
            type: "post",
            dataType: "json",
            data: {
                'mobileBrand': vm.listType
            },
...
//        初始化avalon
        ...
        $(".optionSwitch a").click(function () {
            ...
            vm.listType = $(this).attr("listType");
            getCountsWithAjax(vm);
